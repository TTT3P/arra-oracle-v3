...
export const KNOWN_ENV_KEYS = [
  ...
  'ORACLE_HTTP_IDLE_TIMEOUT_S',
  'ORACLE_SEARCH_BUDGET_MS',
  'ORACLE_SEARCH_MAX_INFLIGHT',
  'ORACLE_MEMORY_FANOUT_CONFIDENCE_WEIGHT',
  'ORACLE_MEMORY_USAGE_CONFIDENCE_WEIGHT',
  'ARRA_MEMORY_FANOUT_CONFIDENCE_WEIGHT',
  'ORACLE_CONSOLIDATION_WORKER',
  'ORACLE_CONSOLIDATION_WORKER_INTERVAL_MS',
  'ORACLE_CONSOLIDATION_SIMILARITY_THRESHOLD',
  'ORACLE_CONSOLIDATION_LLM',
  'ORACLE_CONSOLIDATION_LLM_CAP',
  'ORACLE_ASK_LLM',
  'ORACLE_ASK_LLM_URL',
  'ORACLE_PORT',
  'ORACLE_DATA_DIR',
  ...
  'ORACLE_EMBEDDER_PROBE_TIMEOUT_MS',
  'ORACLE_EMBED_KEEP_ALIVE',
